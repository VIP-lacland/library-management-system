        ...
        <div class="card-body">
          ...
          <form action="<?= url('index.php?action=register/process') ?>" method="POST">
            ...
            <div class="mb-3 input_box">
              ...
              <input type="text" class="form-control" id="username" name="username" value="<?= htmlspecialchars($_SESSION['old']['username'] ?? '') ?>" required>
            </div>
            ...
            <div class="mb-3 input_box">
              ...
              <small class="text-muted"><br>Tối thiểu 8 ký tự</small>
            </div>
